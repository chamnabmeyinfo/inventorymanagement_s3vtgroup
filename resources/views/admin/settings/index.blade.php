...
<div class="card">
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}">
        ...
        <div class="form-group">
            ...
            <input type="email" name="alert_email" value="{{ old('alert_email', $values['alert_email'] ?? '') }}" placeholder="owner@example.com">
            <small style="color: #64748b;">Receives low-stock alerts when scheduled command runs. Requires MAIL_* configured.</small>
        </div>
        <div class="form-group">
