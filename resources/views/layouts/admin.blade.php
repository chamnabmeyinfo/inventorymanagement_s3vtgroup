...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .app-shell.sidebar-expanded .sidebar-theme { width: 100%; min-width: 0; }
        .sidebar-theme:hover { background: var(--sidebar-hover-bg); color: var(--sidebar-accent); }
        ...
        .topbar-user { display: flex; align-items: center; gap: 12px; font-size: 0.8125rem; color: var(--win-text-secondary); }
